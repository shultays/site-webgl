...
var inBetween = function(mx, my, quad) {
    return mx > quad[0] && mx < quad[1] && my > quad[2] && my < quad[3];
}

var textUnderline = function(context, text, x, y, color, textSize, extraWidth){
    ...
    var underlineHeight = parseInt(textSize)/25;

    if (extraWidth){
        underlineHeight += extraWidth
    }
    context.beginPath();
